...
3. Read `.claude/nupp.local.md` using the Read tool (per-project context file).
...
- `swot_entry`: `{ "type": "strength|weakness|opportunity|threat", "title", "content", "need_ids": [], "impact": "high|medium|low", "source": "advisor_nupp" }`
